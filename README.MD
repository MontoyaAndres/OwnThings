...
I've created some bash script to automated the process to install the typical tools. First, you need to have git installed `sudo apt install git` and configure your environment
